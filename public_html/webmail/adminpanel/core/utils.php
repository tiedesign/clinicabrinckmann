<?php
	...
	class ap_Utils
	{
		 ...
		 * @return string
		 */
		static public function AttributeQuote($sValue)
		{
		 ...
		 * @return string
		 */
		static public function ReBuildStringToJavaScript($sJsDesc, $sDeq = null)
		{
		 ...
		 * @return string
		 */
		static public function ClearStringValue($sDesc, $sDeq = null)
		{
