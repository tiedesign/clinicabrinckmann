...
class ap_Standard_Screen extends ap_Screen
{
	...
	public function MiddleModuleInit()
	{
		...
		{
			$_SESSION[$sScreenName.self::SESS_MODE] = $_GET['mode'];
		}

		$this->sMode = isset($_SESSION[$sScreenName.self::SESS_MODE])
			? $_SESSION[$sScreenName.self::SESS_MODE] : $this->aMenuDefMode;
	}
	...
	public function GetCurrentMode()
	{
		...
		if (empty($this->sMode))
		{
			...
			{
				$this->sMode = $sKeyName;
				$_SESSION[$sScreenName.self::SESS_MODE] = $this->sMode;
				break;
			}
		}
