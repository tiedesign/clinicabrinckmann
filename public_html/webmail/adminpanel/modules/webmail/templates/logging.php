...
<tr>
	<td align="left">
		...
		<br />
		<input id="btnViewLog" type="button" class="wm_button" value="View log (only <?php $this->Data->PrintInputValue('MaxViewSize') ?>)" />
	</td>
	<td align="left">
...
<tr>
	<td align="left">
		...
		<br />
		<input id="btnUserActivityViewLog" type="button" class="wm_button" value="View log (only <?php $this->Data->PrintInputValue('MaxViewSize') ?>)" />
	</td>
	<td align="left">
