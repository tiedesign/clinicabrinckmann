...
class CAppBaseHttp
{
	 ...
	 * @return mixed
	 */
	public function GetSession($sKey, $nmDefault = null)
	{
	 ...
	 * @return void
	 */
	public function SetSession($sKey, $mValue)
	{
		CApi::Log('SESS: set['.$sKey.'] = '.print_r($mValue, true));
	 ...
	 * @return void
	 */
	public function DeleteSession($mKey)
	{
		if (is_string($mKey))
		{
			unset($_SESSION[$mKey]);
