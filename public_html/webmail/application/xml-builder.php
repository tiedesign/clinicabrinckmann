...
class CAppXmlBuilder
{
	 ...
	 * @return void
	 */
	static public function BuildContactList(CXmlDocument &$oRequestXml, CXmlDocument &$oResultXml, $oAccount, $oApiContactsManager, $iNewContactId = -1)
	{
	 ...
	 * @return void
	 */
	static public function BuildContact(CXmlDocument &$oResultXml, $oContact, $oApiContactsManager)
	{
	 ...
	 * @return void
	 */
	static public function BuildGroup(CXmlDocument &$oResultXml, $oGroup, $oApiContactsManager)
	{
		$oGroupNode = new CXmlDomNode('group');
	 ...
	 * @return void
	 */
	static public function BuildFilterList(CXmlDocument &$oResultXml, $oFilters, $iAccountId)
	{
	 ...
	 * @return void
	 */
	static public function BuildIdentities(CXmlDocument &$oResultXml, $aAccounts)
	{
	...
	static protected function buildContactOfMessage(&$oResultXml, $oAccount, &$oFromNode, $sEmail)
	{
	 ...
	 * @return void
	 */
	static public function BuildMessage(CXmlDocument &$oResultXml, CAccount $oAccount,
		&$oMailProcessor, $oMessage, $oFolder, $iMode, $iCharsetNum, $bShowImages)
	{
		...
		if (($iMode & 128) == 128)
		{
			$oMessageNode->AppendChild(new CXmlDomNode('full_headers',
				$oMessage->ClearForSend(ConvertUtils::ConvertEncoding(
	 ...
	 */
	static public function BuildAccountImapQuotaNode(CXmlDocument &$oResultXml, $iAccountId, $iAccountSizeLimit = 0, $iAccountSize = 0)
	{
	 ...
	 * @return void
	 */
	static public function BuildSettingsList(CXmlDocument &$oResultXml, CAccount $oAccount, $oDomain)
	{
		$oSettings =& CApi::GetSettings();
		...
		$oSettingsListNode->AppendAttribute('allow_calendar', (int) $oAccount->User->AllowCalendar);
		$oSettingsListNode->AppendAttribute('imap4_delete_like_pop3', (int) 1); // TODO hc
		...
		$oSettingsListNode->AppendAttribute('mobile_sync_enable_system', (int) $oSettings->GetConf('Common/EnableMobileSync'));
	 ...
	 * @return void
	 */
	static public function BuildAccountList(CXmlDocument &$oResultXml, $aAccounts, $iCurrentId, $iLastId = -1)
	{
	 ...
	 * @return type
	 */
	static public function BuildMessagesList(CXmlDocument &$oResultXml, $oMessageCollection, $oAccount,
		&$oMailProcessor, $oFolder, $sLookFor, $iLookField, $iPage, $iSortField, $iSortOrder, $iFilter = APP_MESSAGE_LIST_FILTER_NONE)
	{
		if (is_a($oMessageCollection, 'WebMailMessageCollection') && null !== $oAccount && null !== $oFolder)
		{
			...
			for ($iIndex = 0, $iCount = $oMessageCollection->Count(); $iIndex < $iCount; $iIndex++)
			{
				...
				$oMessageNode->AppendAttribute('flags', $oMessage->Flags);
	 ...
	 * @return void
	 */
	static public function BuildFolders(CXmlDocument &$oResultXml, $oFolders, $oAccount, $oMailProcessor)
	{
		...
		CAppXmlBuilder::BuildFolderList($oFoldersList, $oFolders, $oMailProcessor, $oAccount);
	 ...
	 * @return void
	 */
	static public function BuildFolderList(CXmlDomNode &$oFoldersNode, $oFolders, $oMailProcessor, $oAccount)
	{
		for ($iIndex = 0, $iCount = $oFolders->Count(); $iIndex < $iCount; $iIndex++)
		{
			...
			$oFolderNode->AppendAttribute('hide', (int) (($oFolder->IsNoSelect()) ? false : $oFolder->Hide));
	 ...
	 * @return void
	 */
	static public function BuildAccount(CXmlDomNode &$oAccountsNode, CAccount $oAccount)
	{
		$oSettings =& CApi::GetSettings();
		$oAccountNode = new CXmlDomNode('account');
