...
//			}
	 ...
	 * @return array
	 */
	abstract static public function GetStaticMap();
	
	/**
	 * @param array $aMap
	 * @return array
	 */
	static public function DbReadKeys($aMap)
	{
		$aResult = array();
	 ...
	 * @return array
	 */
	static public function DbWriteKeys($aMap, $bInsert)
	{
		$aResult = array();
		foreach ($aMap as $sKey => $aTypes)
		{
	 ...
	 * @return array
	 */
	static public function DbUpdateArray($oObject, $oHelper)
	{
		$aResult = array();
	 ...
	 * @return array
	 */
	static public function DbInsertArrays($oObject, $oHelper)
	{
