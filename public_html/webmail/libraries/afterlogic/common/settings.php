...
class api_Settings
{
	...
	protected function initDefaultValues()
	{
		$this->aMap = array(
			...
			'Common/DBHost' => array('localhost', 'string'),
			...
			'Common/DBSlaveHost' => array('localhost', 'string'),
			...
			'Common/MobileSyncUrl' => array('http://your.host.com:8080/funambol/ds', 'string'),
			'Common/MobileSyncContactDataBase' => array('card', 'string'),
			'Common/MobileSyncCalendarDataBase' => array('cal', 'string'),
			...
			'WebMail/UserQuota' => array(0, 'int'), //TODO Magic
			...
			'Calendar/WorkdayStarts' => array(9, 'int'), //TODO Magic
			'Calendar/WorkdayEnds' => array(18, 'int'), //TODO Magic
			...
			'Calendar/EnableOutlookSync' => array(true, 'bool'),
			'Calendar/AutoAddInvitation' => array(true, 'bool'),
