...
class CDbCreator
{
	 ...
	 * @return void
	 */
	static public function ClearStatic()
	{
	 ...
	 * @return CDbMySql
	 */
	static public function ConnectorFabric($aData)
	{
		$oConnector = null;
		if (isset($aData['Type']))
		{
	 ...
	 * @return CMySqlHelper
	 */
	static public function CommandCreatorHelperFabric($iDbType = EDbType::MySQL)
	{
		$oHelper = null;
		switch ($iDbType)
		{
	 ...
	 * @return &CDbMySql
	 */
	static public function &CreateConnector(api_Settings $oSettings)
	{
		$aResult = array();
	 ...
	 * @return &CMySqlHelper
	 */
	static public function &CreateCommandCreatorHelper(api_Settings $oSettings)
	{
...
class CDbStorage
{
	...
	public function __construct(api_Settings $oSettings)
	{
		...
		$this->sPrefix = $oSettings->GetConf('Common/DBPrefix');
