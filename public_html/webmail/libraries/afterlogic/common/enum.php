...
class EnumConvert
{
	 ...
	 * @return array
	 */
	static protected function GetInst($sClassName)
	{
	 ...
	 * @return int
	 */
	static public function FromXml($sXmlValue, $sClassName)
	{
		$aConsts = EnumConvert::GetInst($sClassName);
	 ...
	 * @return int
	 */
	static public function FromPost($sXmlValue, $sClassName)
	{
	 ...
	 * @return string
	 */
	static public function ToXml($iValue, $sClassName)
	{
		$aConsts = EnumConvert::GetInst($sClassName);
	 ...
	 * @return string
	 */
	static public function ToPost($iValue, $sClassName)
	{
