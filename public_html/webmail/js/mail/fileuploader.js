...
qq.FileUploader = function(o){
	...
	qq.extend(this._options, {
		...
		listElement: null,
		template:'<div class="wm_upload_drop_cont">'
				+ '<div class="wm_upload_drop_area"></div>'
				+ '<span class="wm_upload_button"><span id="fileuploader_click_to_attach">' + Lang.FileUploaderClickToAttach + '</span></span>'
		...
		classes: {
			...
			//vasil
			button: 'wm_upload_button',
			//
			drop: 'wm_upload_drop_area',
			dropCont: 'wm_upload_drop_cont',
...
qq.extend(qq.FileUploader.prototype, {
	_initLang: function ()
	{
		...
		if (clickToAttachElem) {
			WebMail.langChanger.register('innerHTML', clickToAttachElem, 'FileUploaderClickToAttach', '');
		}
...
qq.UploadButton = function(o){
	this._options = {
		...
		onChange: function(input){},
		//vasil
		hoverClass: 'wm_upload_button hover',
		focusClass: 'wm_upload_button focus'
		//
		};
