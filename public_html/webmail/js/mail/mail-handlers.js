...
{
	var contactsGroups = new CContacts('', this.Keyword, '', CONTACTS_SEARCH_TYPE_FREQUENCY);
...
{
	if (WebMail && WebMail.ScreenId == SCREEN_NEW_MESSAGE && !HtmlEditorField.executeStarted()) {
		var screen = WebMail.Screens[SCREEN_NEW_MESSAGE];
