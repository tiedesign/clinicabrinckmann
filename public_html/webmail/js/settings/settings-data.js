...
CMobileSyncData.prototype = {
	...
	getFromXml: function(rootElement)
	{
		this.editEnable = XmlHelper.getBoolAttributeByName(rootElement, 'enable_system', this.editEnable);
		this.userEnable = XmlHelper.getBoolAttributeByName(rootElement, 'enable_account', this.userEnable);
		...
		var calendarDataBaseNode = XmlHelper.getFirstChildNodeByName(rootElement, 'calendar_db');
		this.calendarDataBase = XmlHelper.getFirstChildValue(calendarDataBaseNode, this.calendarDataBase);

		var contactDataBaseNode = XmlHelper.getFirstChildNodeByName(rootElement, 'contact_db');
		this.contactDataBase = XmlHelper.getFirstChildValue(contactDataBaseNode, this.contactDataBase);

		var urlNode = XmlHelper.getFirstChildNodeByName(rootElement, 'url');
		this.url = XmlHelper.getFirstChildValue(urlNode, this.url);
	}
};
