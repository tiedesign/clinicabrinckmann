...
//public
	...
	{
		if (this._fold.type != FOLDER_TYPE_DEFAULT && foldType == FOLDER_TYPE_DEFAULT) {
			this._fold.name = this._fold.realName;
		}
	...
	getInXml: function () {
		...
		var name = (this._fold.type != FOLDER_TYPE_DEFAULT) ? this._fold.realName : this._fold.name;
...
//private
	...
	_init: function () {
		this._fold.name = CFolder.prototype.getNameByType(this._fold.type, this._fold.realName);
		var obj = this;
