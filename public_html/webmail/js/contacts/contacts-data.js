	...
	_readContactOrGroup: function (contactNode)
	{
		...
		switch (this.searchType) {
			case CONTACTS_SEARCH_TYPE_FREQUENCY:
				...
				this.list.push({ sContactId: sContactId, isGroup: isGroup, displayText: displayText, replaceText: replaceText, clearEmail: clearEmail });
				break;
			...
			default:
				...
				this.list.push({ sContactId: sContactId, isGroup: isGroup, name: name, email: email, clearEmail: clearEmail });
				break;
		}
	}
};
