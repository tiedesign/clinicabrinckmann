...
class CAdminpanelStep extends AInstallerStep
{
	...
	public function DoPost()
	{
		if (isset($_POST['next_btn']))
		{
			...
			{
				$_SESSION['wm_install_pass_error'] = 'Minimum password length is 5 characters.';
			}
			else if (CPost::Get('txtPassword1', '') !== CPost::Get('txtPassword2', ''))
			{
				$_SESSION['wm_install_pass_error'] = 'The password and its confirmation don\'t match.';
			}
			else
			{
	...
	{
		$sFootError = '';
		if (isset($_SESSION['wm_install_pass_error']))
		{
			$sFootError = $_SESSION['wm_install_pass_error'];
			unset($_SESSION['wm_install_pass_error']);;
		}
