...
define('JS_LANG_ReloadFolders', 'Päivitä kansiorakenne');
...
define('JS_LANG_OnMailServer', 'Luo kansio sekä WebMailiin että postipalvelimelle');
define('JS_LANG_InWebMail', 'Luo kansio vain WebMailiin');
...
define('Title_CheckSharedCalendars', 'Tarkista jaetut kalenterit');
...
define('AppointmentMayBe', 'Epävarmat');
...
define('AttachmentPending', 'Ladataan...');
define('AttachmentUploading', 'Ladataan...');
define('AttachmentComplete', 'valmis.');
define('AttachmentCancelled', 'Peruutettu.');
define('AttachmentStopped', 'Pysäytetty.');
define('AttachmentsUpload', 'Liitä tiedostoja');
