...
//					$folder->SubFolders = null;
		...
		function _sortFolderCollection($oAccount, $sortSpecialFolders = false)
		{
			...
			if ($sortSpecialFolders)
			{
				...
				{
					$this->_localSortFunction($oAccount, $sFolderName, $newFoldersArray, $newFolders, EFolderType::Inbox === $iFolderType);
				}

				$this->_localSortFunction($oAccount, '[Gmail]', $newFoldersArray, $newFolders, true);
			}
		...
		function _localSortFunction($oAccount, $folderName, &$newFoldersArray, &$newFolders, $subSort = false)
		{
