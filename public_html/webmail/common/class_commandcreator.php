 ...
 */
	...
	class CommandCreator
	{
		...
		function UpdateMessageCharset(&$account, $msgId, $charset, &$message)
		{
			...
			$from = new I18nString($message->GetFromAsString(), CPAGE_UTF8);
			$to = new I18nString($message->GetToAsString(), CPAGE_UTF8);
			$cc = new I18nString($message->GetCcAsString(), CPAGE_UTF8);
			$bcc = new I18nString($message->GetBccAsString(), CPAGE_UTF8);
			$subject = new I18nString($message->GetSubject(), CPAGE_UTF8);
